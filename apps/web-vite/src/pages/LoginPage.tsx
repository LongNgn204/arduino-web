...
export default function LoginPage() {
    ...
    return (
        <AuthLayout
            ...
            subtitle="Đăng nhập để tiếp tục hành trình khám phá thế giới IoT."
        >
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                    <div className="flex justify-between items-center">
                        ...
                        <Link to="/forgot-password" className="text-xs font-semibold text-arduino-teal hover:underline">
                            Quên mật khẩu?
                        </Link>
                    </div>
                ...
                <Button
                    type="submit"
                    className="w-full py-6 text-base font-bold shadow-lg shadow-arduino-teal/20 hover:shadow-arduino-teal/30 hover:-translate-y-0.5 transition-all"
                    disabled={isLoading}
                >
                ...
                <div className="relative my-8">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-4 text-gray-500 bg-gray-50">Hoặc tiếp tục với</span>
                    </div>
                </div>

                <div className="grid grid-cols-2 gap-4">
                    <button type="button" className="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl hover:bg-gray-100 transition-colors bg-white font-medium text-gray-700">
                    ...
                    <button type="button" className="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl hover:bg-gray-100 transition-colors bg-white font-medium text-gray-700">
                        ...
                        GitHub (đang phát triển...)
                    </button>
                </div>

                <p className="text-center text-gray-600 mt-8">
                    Chưa có tài khoản?{' '}
                    <Link to="/register" className="font-bold text-arduino-teal hover:text-teal-600 transition-colors">
                        Đăng ký ngay
                    </Link>
                </p>
            </form>
