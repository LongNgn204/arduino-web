-- 1. SEED STRUCTURE (Course, Topics, Weeks)
-- Run: npx wrangler d1 execute arduino-db --local --file=src/db/seed_structure.sql

-- Clean up (Safe to run multiple times)
DELETE FROM weeks;
DELETE FROM topics;
DELETE FROM courses;
...
VALUES ('course-01', 'IOT2026', 'Lập trình IoT & Hệ thống nhúng (2026 Update)', 'Khóa học toàn diện từ cơ bản đến nâng cao với Arduino Uno và ESP32.', 1);
