-- Topics & Weeks Seed
-- Run: npx wrangler d1 execute arduino-db --local --file=src/db/seed_topics_weeks.sql

DELETE FROM weeks;
DELETE FROM topics;

-- Re-insert Course if missing (OR IGNORE)
INSERT OR IGNORE INTO courses (id, code, title, description, is_published) 
...
('topic-05', 'course-01', 5, 'Dự án (Capstone)', 'Xây dựng sản phẩm hoàn chỉnh IoT.', 'box');
