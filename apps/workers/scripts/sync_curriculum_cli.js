...
function main() {
    ...
    files.forEach(file => {
        ...
        if (!match) {
            console.warn(`⚠️  Skipping file (invalid naming): ${file}`);
            return;
        }
        ...
        // If title has "Tuần X: ...", clean it up slightly if needed, or keep it.
        // Provide a cleaner title for the 'weeks' table if possible.
        // Example: "Tuần 4: Phần mềm Hệ thống Nhúng - Analog Input/Output (ADC & PWM)"
